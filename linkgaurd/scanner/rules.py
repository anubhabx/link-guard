...
class EnvironmentRules:
    ...
    def check_url(self, url: str, file_path: str, line_number: int | None) -> RuleViolation | None:
        ...
        if self.mode == "prod":
            if self.localhost_regex.search(url):
                return RuleViolation(
                    ...
                    severity="error",
                    message="Localhost or development URLs are not allowed in production mode.",
                    file_path=file_path,
